...
Require Import nondet.coqutil.Decidable. (* already defines several BoolSpec instances *)
...
Require Import nondet.coqutil.Datatypes.Inhabited.
Require Coq.Lists.List nondet.coqutil.Datatypes.List.
